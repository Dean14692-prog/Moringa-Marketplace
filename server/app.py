...
CORS_ORIGINS = [
    ...
    "https://moringa-marketplace-3bpi-4cds0lcmo-dennis-nguis-projects.vercel.app"
]
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///' + os.path.join(app.instance_path, 'moringa_marketplace.db')
...
def google_login():
    ...
    return jsonify({"access_token": token, "user": {"email": email, "name": name}})
#####################################google login###############################################
