...
Revision ID: b1a0dc4a55a5
Revises: 
Create Date: 2025-07-20 22:00:49.293052
...
def upgrade():
    ...
    sa.UniqueConstraint('student_id', 'project_id', name='_student_project_uc')
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('team_project_student_id', sa.Integer(), nullable=False),
    sa.Column('team_project_project_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['team_project_project_id'], ['team_projects.project_id'], ),
    sa.ForeignKeyConstraint(['team_project_student_id', 'team_project_project_id'], ['team_projects.student_id', 'team_projects.project_id'], ),
    sa.ForeignKeyConstraint(['team_project_student_id'], ['team_projects.student_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
