      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Explore <span className="bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">Career Tracks</span>
          </h2>
            ...
            >
              <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                <img
                  ...
                  loading="lazy"
                />
                <div className={`absolute inset-0 bg-gradient-to-t ${item.color} via-transparent`}>
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform transition-transform duration-500 group-hover:-translate-y-2">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="text-sm font-medium tracking-wider">{item.category}</span>
                    </div>
                    ...
                    >
                      Learn more <IconArrowRight size={16} className="ml-1 transition-transform group-hover:translate-x-1" />
                    </a>
                  </div>
                </div>
              </div>
