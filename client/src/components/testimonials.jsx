...
export default function AnimatedTestimonials() {
  ...
  return (
    <div className="w-screen min-h-screen bg-[#deeaee] text-black font-sans">
      <div className="max-w-7xl mx-auto h-full px-4 py-20">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-16 max-w-5xl mx-auto">
          ...
          <div className="text-center lg:text-left max-w-xl">
            ...
            >
              ...
              <motion.p className="mt-6 text-lg text-gray-900">
