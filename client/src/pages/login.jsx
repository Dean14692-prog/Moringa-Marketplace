  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center px-4 overflow-hidden relative bg-black">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(/blue-wave-is-lit-up-black-background_889227-20579.png)',
          opacity: 0.7
        }}
      >
      ...
      <div className="w-full max-w-md p-8 rounded-2xl z-10 relative overflow-hidden">
        ...
        <div className="relative z-10">
              ...
              <div className="relative w-full">
                <GoogleOAuthProvider clientId={import.meta.env.VITE_GOOGLE_CLIENT_ID}>
                  <GoogleLogin
                    ...
                    shape="rectangular"
                    width="100%"
                    className={`w-full google-signin-button ${isLoading ? 'opacity-50' : ''}`}
                    disabled={isLoading}
                    ux_mode="popup"
          ...
          <p className="text-center mt-2">
            <Link to="/forgot-password" className="text-xs text-gray-500 hover:text-blue-400 transition-colors">
